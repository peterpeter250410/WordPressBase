                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div>
                                ...
                                <p><?php echo esc_html(eikou_get('eikou_tel', '03-5876-9273')); ?></p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                <strong><?php esc_html_e('LINE', 'eikou'); ?></strong>
                                <p><?php echo esc_html(eikou_get('eikou_line', 'eikoten')); ?></p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                <strong><?php esc_html_e('WeChat', 'eikou'); ?></strong>
                                <p><?php echo esc_html(eikou_get('eikou_wechat', 'zhanlan896')); ?></p>
                            </div>
                        </li>
                        <li>
