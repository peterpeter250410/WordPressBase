...
<div class="h5-menu-overlay" id="h5MenuOverlay">
    ...
    <div class="h5-menu-inner">
        ...
        <div class="h5-menu-contact">
            <a href="tel:<?php echo esc_attr(preg_replace('/[^0-9+]/', '', eikou_get('eikou_tel', '03-5876-9273'))); ?>" class="btn btn-outline">
                ...
                <?php echo esc_html(eikou_get('eikou_tel', '03-5876-9273')); ?>
            </a>
